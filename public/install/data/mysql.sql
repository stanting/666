...
CREATE TABLE pre_category (
  ...
  pid int(10) NOT NULL DEFAULT '0',			# 上级ID
...
DROP TABLE IF EXISTS pre_alias;
CREATE TABLE pre_alias (
...
DROP TABLE IF EXISTS pre_article_data;
CREATE TABLE pre_article_data (
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
...
# 文章附件表
DROP TABLE IF EXISTS pre_article_attach;
CREATE TABLE pre_article_attach (
  aid int(10) unsigned NOT NULL AUTO_INCREMENT,		# 附件ID
  cid smallint(5) unsigned NOT NULL DEFAULT '0',	# 分类ID
  uid int(10) unsigned NOT NULL DEFAULT '0',		# 用户ID
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  filename char(80) NOT NULL DEFAULT '',		# 文件原名
  filehash char(32) NOT NULL DEFAULT '',		# 文件HASH
...
# 文章查看数表，用来分离主表的写压力
DROP TABLE IF EXISTS pre_article_views;
CREATE TABLE pre_article_views (
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  cid smallint(5) unsigned NOT NULL DEFAULT '0',	# 分类ID
...
DROP TABLE IF EXISTS pre_article_comment_sort;
CREATE TABLE pre_article_comment_sort (
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  cid smallint(5) unsigned NOT NULL DEFAULT '0',	# 分类ID
  comments int(10) unsigned NOT NULL DEFAULT '0',	# 评论数
...
# 文章标签数据表
DROP TABLE IF EXISTS pre_article_tag_data;
CREATE TABLE pre_article_tag_data (
...
DROP TABLE IF EXISTS pre_product_data;
CREATE TABLE pre_product_data (
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
...
# 产品属性标记表
DROP TABLE IF EXISTS pre_product_flag;
CREATE TABLE pre_product_flag (
  flag tinyint(1) unsigned NOT NULL DEFAULT '0',	# 属性标记
  cid int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  PRIMARY KEY  (flag,id),
...
# 产品附件表
DROP TABLE IF EXISTS pre_product_attach;
CREATE TABLE pre_product_attach (
  aid int(10) unsigned NOT NULL AUTO_INCREMENT,		# 附件ID
  cid smallint(5) unsigned NOT NULL DEFAULT '0',	# 分类ID
  uid int(10) unsigned NOT NULL DEFAULT '0',		# 用户ID
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
...
# 产品查看数表，用来分离主表的写压力
DROP TABLE IF EXISTS pre_product_views;
CREATE TABLE pre_product_views (
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  cid smallint(5) unsigned NOT NULL DEFAULT '0',	# 分类ID
  views int(10) unsigned NOT NULL DEFAULT '0',		# 查看次数
  PRIMARY KEY  (id),
...
DROP TABLE IF EXISTS pre_product_comment_sort;
CREATE TABLE pre_product_comment_sort (
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  cid smallint(5) unsigned NOT NULL DEFAULT '0',	# 分类ID
  comments int(10) unsigned NOT NULL DEFAULT '0',	# 评论数
  lastdate int(10) unsigned NOT NULL DEFAULT '0',	# 回复时间
...
# 产品评论表 (审核机制考虑单独设计一张表)
DROP TABLE IF EXISTS pre_product_comment;
CREATE TABLE pre_product_comment (
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  commentid int(10) unsigned NOT NULL AUTO_INCREMENT,	# 评论ID
  uid int(10) unsigned NOT NULL DEFAULT '0',		# 用户ID
  author char(30) NOT NULL DEFAULT '',			# 作者，可能不等于 username
...
# 产品标签数据表
DROP TABLE IF EXISTS pre_product_tag_data;
CREATE TABLE pre_product_tag_data (
  tagid int(10) unsigned NOT NULL,			# tagID
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  PRIMARY KEY  (tagid,id)				# 排序要用id
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
DROP TABLE IF EXISTS pre_photo;
CREATE TABLE pre_photo (
  cid smallint(5) unsigned NOT NULL DEFAULT '0',	# 分类ID
  id int(10) unsigned NOT NULL AUTO_INCREMENT,		# 内容ID
  title char(80) NOT NULL DEFAULT '',			# 标题
  color char(6) NOT NULL DEFAULT '',			# 标题颜色
...
DROP TABLE IF EXISTS pre_photo_data;
CREATE TABLE pre_photo_data (
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  images mediumtext NOT NULL,				# 图集 (json储存)
  content mediumtext NOT NULL,				# 内容
  PRIMARY KEY  (id)
...
# 图集属性标记表
DROP TABLE IF EXISTS pre_photo_flag;
CREATE TABLE pre_photo_flag (
  flag tinyint(1) unsigned NOT NULL DEFAULT '0',	# 属性标记
  cid int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  PRIMARY KEY  (flag,id),
...
# 图集附件表
DROP TABLE IF EXISTS pre_photo_attach;
CREATE TABLE pre_photo_attach (
  aid int(10) unsigned NOT NULL AUTO_INCREMENT,		# 附件ID
  cid smallint(5) unsigned NOT NULL DEFAULT '0',	# 分类ID
  uid int(10) unsigned NOT NULL DEFAULT '0',		# 用户ID
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
...
# 图集查看数表，用来分离主表的写压力
DROP TABLE IF EXISTS pre_photo_views;
CREATE TABLE pre_photo_views (
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  cid smallint(5) unsigned NOT NULL DEFAULT '0',	# 分类ID
  views int(10) unsigned NOT NULL DEFAULT '0',		# 查看次数
  PRIMARY KEY  (id),
...
DROP TABLE IF EXISTS pre_photo_comment_sort;
CREATE TABLE pre_photo_comment_sort (
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  cid smallint(5) unsigned NOT NULL DEFAULT '0',	# 分类ID
  comments int(10) unsigned NOT NULL DEFAULT '0',	# 评论数
  lastdate int(10) unsigned NOT NULL DEFAULT '0',	# 回复时间
...
# 图集评论表 (审核机制考虑单独设计一张表)
DROP TABLE IF EXISTS pre_photo_comment;
CREATE TABLE pre_photo_comment (
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  commentid int(10) unsigned NOT NULL AUTO_INCREMENT,	# 评论ID
  uid int(10) unsigned NOT NULL DEFAULT '0',		# 用户ID
  author char(30) NOT NULL DEFAULT '',			# 作者，可能不等于 username
...
# 图集标签表
DROP TABLE IF EXISTS pre_photo_tag;
CREATE TABLE pre_photo_tag (
  tagid int(10) unsigned NOT NULL AUTO_INCREMENT,	# tagID
  name char(10) NOT NULL DEFAULT '',			# tag名称
  count int(10) unsigned NOT NULL DEFAULT '0',		# tag数量
  content text NOT NULL,				# tag内容
...
# 图集标签数据表
DROP TABLE IF EXISTS pre_photo_tag_data;
CREATE TABLE pre_photo_tag_data (
  tagid int(10) unsigned NOT NULL,			# tagID
  id int(10) unsigned NOT NULL DEFAULT '0',		# 内容ID
  PRIMARY KEY  (tagid,id)				# 排序要用id
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
# 记录其它表的总行数
DROP TABLE IF EXISTS pre_table_count;
CREATE TABLE pre_table_count (
...
# 记录其它表的最大ID
DROP TABLE IF EXISTS pre_table_maxid;
CREATE TABLE pre_table_maxid (
  name char(32) NOT NULL DEFAULT '',			# 表名
