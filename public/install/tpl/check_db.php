...
<div class="content">
	...
	<table class="tb">
		...
		<tr>
			<td>用户名</td>
			<td><input class="inp" id="dbuser" name="dbuser" type="text" value="git" tips="请填写数据库用户名"></td>
		</tr>
		<tr>
			<td>密码</td>
			<td><input class="inp" id="dbpw" name="dbpass" type="password" value="ABCabc123@" tips="请填写数据库密码"></td>
		</tr>
		<tr>
			<td>数据库名</td>
			<td><input class="inp" id="dbname" name="dbname" type="text" value="git" tips="请填写数据库名"></td>
		</tr>
		<tr>
			<td>表前辍</td>
			<td><input class="inp" id="dbpre" name="dbpre" type="text" value="t_" tips="如安装多套twcms，请修改"></td>
		</tr>
		<tr>
			<td>覆盖安装</td>
	...
	<table class="tb">
		...
		<tr>
			<td>密码</strong></td>
			<td><input class="inp" id="adm_pass" name="adm_pass" type="password" value="admin123" tips="请填写密码，不能小于8位"></td>
		</tr>
	</table>
</div>
